...
foreach ($configuredSites as $siteId => $siteMeta) {
    ...
    $sanitizedSites[$siteId] = [
        ...
        'custom_script_content' => $siteMeta['custom_script_content'] ?? '',
        ...
        'pm2_ecosystem_type' => $siteMeta['pm2_ecosystem_type'] ?? 'code',
        'pm2_ecosystem_path' => $siteMeta['pm2_ecosystem_path'] ?? '',
        'pm2_script' => $siteMeta['pm2_script'] ?? '',
        'pm2_name' => $siteMeta['pm2_name'] ?? $siteId,
        'pm2_ecosystem' => $pm2Ecosystem,
        'terminal_enabled' => !empty($siteMeta['terminal_enabled']),
        'terminal_path' => $siteMeta['terminal_path'] ?? '',
